...
const ExtraSectionOne = () => {
  return (
    <div className="md:h-[500px] flex items-center justify-center bg-slate-50">
      ...
      <div className="border rounded-xl bg-[#F3F4F6] p-5 md:p-10">
           ...
           <p className="md:text-2xl text-xl my-2 font-bold text-[#034833]">Food and Wine Tours</p>
           <p className="text-[#034833] text-sm md:text-[14]">
        ...
        <div className="border rounded-xl p-5 bg-[#F3F4F6]">
            ...
            size={50} />   </h1>
            <p className="md:text-2xl text-lg my-2 font-bold text-[#034833]">Travel Opportunities</p>
            <p className="text-[#034833] text-sm md:text-[14px]" >"Dolor sit amet, consectetur adipiscing elit. Sed sit amet rcus nunc. Duis egestas ac."</p>
        </div>
        <div className="border rounded-xl bg-[#F3F4F6] p-5">
            ...
            <p className="md:text-2xl text-lg my-2 font-bold text-[#034833]">Solo Travel Planning</p>
            <p className="text-[#034833] text-sm md:text-[14px]">"Dolor sit amet, consectetur adipiscing elit. Sed sit amet rcus nunc. Duis egestas ac."</p>
        </div>
      </div>
    </div>
